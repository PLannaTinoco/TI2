...
public class UsuarioService 
{
	...
	public void makeForm( int tipo, Usuario usuario, int orderBy ) 
	{
		...
		if(tipo != FORM_INSERT) 
		{
			umClinte += "\t<table width=\"80%\" bgcolor=\"#f3f3f3\" align=\"center\">";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;<a href=\"/usuario/list/1\">Novo usuario</a></b></font></td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t</table>";
			umClinte += "\t<br>";			
		} // end if
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) 
		{
			...
			umClinte += "\t<form class=\"form--register\" action=\"" + action + "\" method=\"post\" id=\"form-add\">";
			umClinte += "\t<table width=\"80%\" bgcolor=\"#f3f3f3\" align=\"center\">";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td colspan=\"3\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;" + name + "</b></font></td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td colspan=\"3\" align=\"left\">&nbsp;</td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td>&nbsp;Login: <input class=\"input--register\" type=\"text\" name=\"login\" value=\""+ login +"\"></td>";
			umClinte += "\t\t\t<td>Senha: <input class=\"input--register\" type=\"text\" name=\"senha\" value=\""+ senha +"\"></td>";
			umClinte += "\t\t\t<td>Sexo: <input class=\"input--register\" type=\"text\" name=\"sexo\" value=\""+ usuario.getSexo() +"\"></td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td align=\"center\"><input type=\"submit\" value=\""+ buttonLabel +"\" class=\"input--main__style input--button\"></td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t</table>";
			umClinte += "\t</form>";		
		} 
		else if ( tipo == FORM_DETAIL )
		{
			umClinte += "\t<table width=\"80%\" bgcolor=\"#f3f3f3\" align=\"center\">";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td colspan=\"3\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Detalhes do usuario ( Codigo " + usuario.getCodigo() + " )</b></font></td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td colspan=\"3\" align=\"left\">&nbsp;</td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td>&nbsp;Codigo: "+ usuario.getCodigo() +"</td>";
			umClinte += "\t\t\t<td>Login: "+ usuario.getLogin() +"</td>";
			umClinte += "\t\t\t<td>Senha: "+ usuario.getSenha() +"</td>";
			umClinte += "\t\t\t<td>Sexo: "+ usuario.getSexo() +"</td>";
			umClinte += "\t\t</tr>";
			umClinte += "\t\t<tr>";
			umClinte += "\t\t\t<td>&nbsp;</td>";
			umClinte += "\t\t</tr>";
		...
		form = form.replaceFirst("<UM-USUARIO>", umClinte);
